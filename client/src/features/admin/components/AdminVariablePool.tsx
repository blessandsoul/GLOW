...
import { useVariablePoolStatus, useReplenishVariablePool } from '../hooks/useAdmin';
...
export function AdminVariablePool(): React.ReactElement {
    const { t } = useLanguage();
    const { pool, isLoading, refetch } = useVariablePoolStatus();
    const { replenish, isPending } = useReplenishVariablePool();
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <Sparkle size={18} weight="fill" className="text-warning" />
                    <h2 className="text-lg font-semibold tracking-tight">
                        {t('admin.variable_pool_title')}
                    </h2>
                    ...
                    return (
                        ...
                        >
                            <p className="text-sm text-muted-foreground">
                                {VARIABLE_LABELS[item.variableId] ?? item.variableId}
                            </p>
                            <p className={cn(
