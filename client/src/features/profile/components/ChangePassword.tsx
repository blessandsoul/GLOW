...
import { Eye, EyeSlash, SpinnerGap, LockKey, ShieldCheck, ArrowLeft, ArrowClockwise, Key } from '@phosphor-icons/react';
            ...
            <section className="space-y-4 rounded-xl border border-border/50 bg-card p-6">
                <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold text-foreground">
                        {hasPassword ? t('ui.profile_change_password') : t('ui.profile_set_password')}
                    </p>
                </div>
