      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-16 flex flex-col items-center">
          <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary mb-3">
            {t('ui.text_oqe2au')}</span>
          <h2 className="text-4xl md:text-5xl font-light tracking-tight text-zinc-900 dark:text-white mb-4">
            {t('ui.text_sqzvf8')}{' '}<span className="italic font-georgian">{t('ui.text_psd5f9')}</span>
          </h2>
