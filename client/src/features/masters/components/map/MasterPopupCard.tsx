    ...
    <AnimatePresence>
      {master && (
        <motion.div
          ...
          className="absolute bottom-28 left-3 right-3 z-1000 overflow-hidden rounded-2xl border border-border/60 bg-card shadow-2xl md:bottom-4 lg:bottom-auto lg:left-auto lg:right-4 lg:top-4 lg:w-80"
        >
          <button
